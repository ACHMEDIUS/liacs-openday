...
print(result)`,
  ...
  return max;
    ...
    correctAnswer: 2,
    explanation: 'Two bugs: loop condition should be < (not <=) to avoid index out of bounds, and max should be initialized to arr[0] to handle negative numbers.',
...
print(message)`,
    ...
    correctAnswer: 2,
    explanation: 'Python cannot concatenate strings with integers directly. Either convert age to string or use f-string formatting.',
    difficulty: 'Easy' as const,
  ...
  setTimeout(function() {
    ...
    correctAnswer: 2,
    explanation: 'The var keyword has function scope, so all timeouts reference the same i. Using let (block scope) or an IIFE would fix this.',
    difficulty: 'Medium' as const,
    category: 'Closures',
  },
  {
  ...
  return arr;
    ...
    correctAnswer: 2,
    explanation: 'The function correctly allocates and returns dynamic memory. The caller is responsible for calling delete[] on the returned pointer.',
    difficulty: 'Hard' as const,
  ...
  return lst`,
    ...
    correctAnswer: 0,
    explanation: 'Modifying a list while iterating over it can cause unexpected behavior. Use a copy or different approach.',
    difficulty: 'Medium' as const,
    category: 'Lists',
  },
  {
  ...
  return data;
    ...
    correctAnswer: 2,
    explanation: 'Both fetch and response.json() return promises and need await in an async function.',
    difficulty: 'Easy' as const,
...
if (str1 == str2) {
  System.out.println("Strings are equal");
    ...
    correctAnswer: 0,
    explanation: 'In Java, == compares object references, not string content. Use .equals() for string comparison.',
    difficulty: 'Easy' as const,
...
result2 = add_item(2)`,
    ...
    correctAnswer: 0,
    explanation: 'Mutable default arguments in Python persist between function calls. Use None as default and create new list inside function.',
    difficulty: 'Hard' as const,
    category: 'Functions',
  },
];
